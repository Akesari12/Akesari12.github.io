...
<h4 style="text-align: left; color:black; margin-bottom:0px">Predicting Cybersecurity Incidents Through Mandatory Disclosure Regulation</h4>
...
<h4 style="text-align: left; color:black; margin-bottom:0px">The Effect of State Data Breach Notification Laws on Medical Identity Theft</h4>
<p align = "justify" style = "margin-top: 0px; font-size:12px"><b>Working Paper</b>
	<br>
